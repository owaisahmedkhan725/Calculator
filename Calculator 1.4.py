...
# Calculator v-1.4
# Calculator+
# This Update Extends the Percentage Function.
# This Update Extends the Action Of Increment And Decrement of X and Y.
# This Update Exdents Action Of Modulus & Square.
