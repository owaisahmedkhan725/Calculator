...
# Calculator v-2.0
# Advance Calculator V2
    #include
        # Calculator   //IMPORT FROM Calculator 1.8.py (Merge)
        # Converter    //Including Converter Option (Extends (Time Conversion),(Unit Conversion)(Distance Conversion))
# Coverters Includes
# 1.Hours to Sec
# 2.Sec To Hours
...
while True:
 ...
 2.Sec To Hours
            ...
            Ask_Exit=(input("Do You Want to Exit From Conversions Y/N : "))
            if(Ask_Exit=='y'):
                print('''
 Exiting Conversions...
 Returning To Main Menu...  
